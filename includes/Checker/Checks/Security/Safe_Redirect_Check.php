...
class Safe_Redirect_Check extends Abstract_PHP_CodeSniffer_Check {
	...
	public function get_description(): string {
		return __( 'Checks that redirects use wp_safe_redirect() instead of wp_redirect() for security.', 'plugin-check' );
	}
	...
	public function get_documentation_url(): string {
		return __( 'https://developer.wordpress.org/reference/functions/wp_safe_redirect/', 'plugin-check' );
	}
