		...
		<?php if (!empty($available_plugins)) { ?>
			...
			<form>
				...
				<select id="plugin-check__plugins-dropdown" name="plugin_check_plugins"
						aria-describedby="plugin-check__description">
				...
				<?php if ($has_experimental_checks) { ?>
					...
					<p>
						<label><input type="checkbox" value="include-experimental"
									  id="plugin-check__include-experimental"/> <?php esc_html_e('Include Experimental Checks', 'plugin-check'); ?>
						</label>
					</p>
				<?php } ?>
